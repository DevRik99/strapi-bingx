...
export interface ApiTraderTrader extends Schema.CollectionType {
  ...
  attributes: {
    ...
    riskLevel30Days: Attribute.Integer;
    riskLevel90Days: Attribute.Integer;
    riskLevel180Days: Attribute.Integer;
    strFollowerNum: Attribute.Integer;
    avgFollowerEarnings: Attribute.Float;
    risks: Attribute.JSON;
    maxRiskInAllTime: Attribute.Float;
    minRiskInAllTime: Attribute.Float;
    averageRiskInAllTime: Attribute.Float;
    isPnLRateAcceptable: Attribute.Boolean;
    isProfitRateAcceptable: Attribute.Boolean;
    isRiskAcceptable: Attribute.Boolean;
    isTradeFrequencyAcceptable: Attribute.Boolean;
    isTotalTransactionsAcceptable: Attribute.Boolean;
    isMinDaysAcceptable: Attribute.Boolean;
    isTotalEarningAcceptable: Attribute.Boolean;
    isFollowersVariationAcceptable: Attribute.Boolean;
    isAceptableRiskTrader: Attribute.Boolean;
    averageRiskLevel: Attribute.Float;
    maxLossDayValue: Attribute.Float;
    ...
    isActive: Attribute.Boolean;
    latest30DaysEarningRatio: Attribute.String;
    maxProfit: Attribute.Float;
    maxLoss: Attribute.Float;
    maxProfitAVG: Attribute.Float;
    maxLossAVG: Attribute.Float;
    aceptableLossAVG: Attribute.Boolean;
    minProfit: Attribute.Float;
    minLoss: Attribute.Float;
    formattedDate: Attribute.String;
    avatar: Attribute.String;
    recent7DaysRate: Attribute.Float;
    recent30DaysRate: Attribute.Float;
    recent90DaysRate: Attribute.Float;
    recent180DaysRate: Attribute.Float;
    winRate: Attribute.Float;
    urlAnalized: Attribute.String;
    copy_standar_futures: Attribute.Boolean;
    copy_perpetual_futures: Attribute.Boolean;
    copy_demo_mode: Attribute.Boolean;
    positionAmount: Attribute.BigInteger;
    orderRate: Attribute.BigInteger;
    blackList: Attribute.Boolean;
    notFoundTrader: Attribute.Boolean;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::trader.trader': ApiTraderTrader;
